...
# credit: https://medium.com/analytics-vidhya/bert-for-topic-modeling-bert-vs-lda-8076e72c602b
...
def main(train_file):
    ...
    plt.show()
    # now the count within each group even
    ...
    embedding_lda = get_document_topic_lda(lda_model, corpus, total_topics)
    labels_lda = []
    for line in corpus:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_file", type=str, default="./dreaddit/dreaddit-train-allTexts.csv",
